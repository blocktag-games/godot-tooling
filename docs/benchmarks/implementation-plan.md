...
Status on 19 September 2026: protocol and catalogs drafted; BP01, BP02, BP03, and BP04 are all closed. An internal review on this date found specific unmet completion evidence in BP02-BP04 and, separately, one incorrect finding in BP04's original write-up (since corrected). All named gaps were closed the same day, including a genuine second-reviewer pass on all 16 oracles by an independent review agent, which itself found and fixed four further issues (see BP02's row). See [pilot-environment.md](pilot-environment.md), [../../pilot/fixtures/](../../pilot/fixtures/), [../../pilot/harness/](../../pilot/harness/), and [../../pilot/adapter-run/](../../pilot/adapter-run/). Work packages below are ordered by dependency. Estimates are planning ranges for one active contributor and will be revised after the first runnable slice.
